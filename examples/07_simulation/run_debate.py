...
async def main():
	...
	pro = engine.load_agent_template(os.path.join(base, "agent_pro.yaml")).instantiate(models=models)
	con = engine.load_agent_template(os.path.join(base, "agent_con.yaml")).instantiate(models=models)
